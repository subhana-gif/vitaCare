...
class PrescriptionService {
    ...
    async createPrescription(prescriptionData) {
        ...
        if (existingPrescription) {
            return await this.prescriptionRepository.updateByAppointmentId(prescriptionData.appointmentId.toString(), prescriptionData);
        }
