...
router.post("/signup", (0, validationMiddleware_1.validate)(), doctorController.registerDoctor.bind(doctorController));
...
router.put("/:id", (0, validationMiddleware_1.validate)(), (0, authMiddleware_1.verifyToken)(["admin", "doctor"]), uploadMiddleware_1.uploadAndSaveToS3, doctorController.updateDoctor.bind(doctorController));
